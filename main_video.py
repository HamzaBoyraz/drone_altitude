...
LOWER_HSV = np.array([{lower_hsv[0]}, {lower_hsv[1]}, 3{lower_hsv[2]}])
...
def main():
    ...
    cv2.resizeWindow("Object Tracker", 640, 480)

    cv2.namedWindow("Threshold Mask", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("Threshold Mask", 640, 480)
    ...
    while cap.isOpened():
        ...
        # SAVE HSV CONFIG TO FILE
            ...
            save_config(lower_hsv, upper_hsv)
